...
public class HistoryConfigInfoMapperBySqlserver extends AbstractMapperBySqlserver implements HistoryConfigInfoMapper {
    ...
    public MapperResult removeConfigHistory(MapperContext context) {
        String sql = "DELETE TOP(?) FROM his_config_info WHERE gmt_modified < ?";
        return new MapperResult(sql, CollectionUtils.list(context.getWhereParameter(FieldConstant.LIMIT_SIZE),
    ...
    public MapperResult getNextHistoryInfo(MapperContext context) {
        String sql = "SELECT TOP 1 nid,data_id,group_id,tenant_id,app_name,content,md5,src_user,src_ip,op_type,publish_type,"
